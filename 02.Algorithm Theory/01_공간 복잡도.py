"""
알고리즘 계산 복잡도는 다음 두가지가 있다.
    - 시간 복잡도: 얼마나 빠른가?
    - 공간 복잡도: 얼마나 저장공간이 필요한가?
좋은 알고리즘은 두 가지 모두 만족시키는 알고리즘이지만, 보통 둘 다 만족하기는 어려움.
    - 시간과 공간은 반비례적 경향이 있음
    - 최근 대용량 시스템이 보편화되면서, 공간 복잡도보다는 시간 복잡도가 우선
    - 그래서! 알고리즘은 시간 복잡도가 중심

그래도 공간 복잡도에 대한 대략적인 계산은 필요함
...
>> 공간 복잡도 (Space Complexity) = 프로그램을 실행 및 완료하는데 필요한 저장공간의 양을 뜻함
    총 필요 저장 공간
